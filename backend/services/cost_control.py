...
class CostControl:
    ...
    def enable_paid_models(self, duration_minutes: int = 60, max_cost: float = 1.0):
        """
    ...
    def log_usage(self, provider: str, cost_estimate: float = 0.0):
