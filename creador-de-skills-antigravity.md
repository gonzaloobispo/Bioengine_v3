...
3. A partir de ahí, para crear un skill nuevo, pide: “Usa mi documento ‘creador-de-skills-antigravity’ y construye un skill para: <tema>. Devuélveme la carpeta, el SKILL.md y los recursos necesarios.”
